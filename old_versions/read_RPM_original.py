...
import time
import pigpio # http://abyz.co.uk/rpi/pigpio/python.htmlsu

class reader:
    """
    A class to read speedometer pulses and calculate the RPM.
    """
    def __init__(self, pi, gpio, pulses_per_rev=1.0, weighting=0.0, min_RPM=30.0):
        """
...
if __name__ == "__main__":
    ...
    p = read_RPM.reader(pi, RPM_GPIO, PULSES_PER_REV)
