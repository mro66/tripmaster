...
def initRallye():
    ...
    POINTS = {
        ...
        "stage_start": POINT("Start Etappe", "fas fa-flag-checkered", "red", "stage_start"),
        "stage_finish": POINT("Ende Etappe", "fas fa-flag-checkered", "green", "stage_finish"),
...
class WebSocketHandler(tornado.websocket.WebSocketHandler):
    ...
    # Strecke
        ...
        # Zeit bis zum Start der Etappe
            ...
            if param == 'null':
                ...
                # TODO - Auf dem Dashboard erscheint eine Uhr auf schwarzem Hintergrund, die die Zeit bis zum Start runterzählt
    ...
    # Settings
        ...
        # Punkte ändern
            ...
            self.write_message("ID " + str(id+1) + " - " + description + " geändert:success")
